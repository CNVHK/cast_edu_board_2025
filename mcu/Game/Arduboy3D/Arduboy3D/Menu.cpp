...
void Menu::Draw()
{
	...
	Font::PrintString(("CATACOMBS OF THE DAMNED"), 0, 0, COLOUR_WHITE);
	Font::PrintString(("by @jameshhoward"), 1, 12, COLOUR_WHITE);
	Font::PrintString(("transplant by @ElectroByte"), 2, 0, COLOUR_WHITE);
	Font::PrintString(("Start"), 3, 12, COLOUR_WHITE);
	Font::PrintString(("Sound:"), 4, 12, COLOUR_WHITE);
	

	if (Platform::IsAudioEnabled())
	{
		Font::PrintString(("on"), 4, 48, COLOUR_WHITE);
	}
	else
	{
		Font::PrintString(("off"), 4, 48, COLOUR_WHITE);
	}
	
	Font::PrintString((">"), 3 + selection, 2, COLOUR_WHITE);
...
{
	Platform::FillScreen(COLOUR_BLACK);
	Font::PrintString(("Entering floor"), 2, 12, COLOUR_WHITE);
	Font::PrintInt(Game::floor, 2, 50, COLOUR_WHITE);
}	
...
{
	Platform::FillScreen(COLOUR_BLACK);
	Font::PrintString(("GAME OVER"), 0, 36, COLOUR_WHITE);

	switch (Game::stats.killedBy)
	{
	case EnemyType::None:
		Font::PrintString(("You escaped the catacombs!"), 1, 12, COLOUR_WHITE);
		break;
	case EnemyType::Mage:
		Font::PrintString(("Killed by a mage on level"), 1, 8, COLOUR_WHITE);
		Font::PrintInt(Game::floor, 1, 112, COLOUR_WHITE);
		break;
	case EnemyType::Skeleton:
		Font::PrintString(("Killed by a knight on level"), 1, 4, COLOUR_WHITE);
		Font::PrintInt(Game::floor, 1, 116, COLOUR_WHITE);
		break;
	case EnemyType::Bat:
		Font::PrintString(("Killed by a bat on level"), 1, 10, COLOUR_WHITE);
		Font::PrintInt(Game::floor, 1, 110, COLOUR_WHITE);
		break;
	case EnemyType::Spider:
		Font::PrintString(("Killed by a spider on level"), 1, 4, COLOUR_WHITE);
		Font::PrintInt(Game::floor, 1, 116, COLOUR_WHITE);
		break;
	}
	
	Font::PrintString(("LOOT:"), 2, 20, COLOUR_WHITE);
	...
	Font::PrintString(("KILLS:"), 2, 84, COLOUR_WHITE);
	...
	Font::PrintString(("FINAL SCORE:"), 7, 20, COLOUR_WHITE);
