...
public:
	...
	static void DrawScaled8(const uint8_t* data, int8_t x, int8_t y, uint8_t halfSize, uint8_t inverseCameraDistance, bool invert);

	static void DrawScaled16(const uint16_t* data, int8_t x, int8_t y, uint8_t halfSize, uint8_t inverseCameraDistance, bool invert);
...
private:
	...
	static void DrawHUD();
	static void DrawBar(const uint8_t *iconData, uint8_t amount, uint8_t max, uint8_t type);
