...
public:
	...
	static void PrintInt(uint16_t value, uint8_t line, uint8_t x, uint8_t colour = COLOUR_BLACK);

private:
	static void DrawChar(uint8_t x0, uint8_t y0, char c, uint8_t colour = COLOUR_BLACK);
};
