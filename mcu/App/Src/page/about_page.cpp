...
about_page::about_page()
{
    ...
    this->key_handlers[USER_KEY_1].on_pressed = [this](key_state) { this->scroll_to_top(); };
}
...
void about_page::update_ui()
{
    ...
    u8g2_DrawXBM(&screen, u8g2_GetDisplayWidth(&screen) - about_bottom_banner_width >> 1, 204 - y,
