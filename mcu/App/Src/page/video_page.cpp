...
void video_page::update_ui()
{
    ...
    u8g2_DrawUTF8(&screen, 14, 37, "按下USER_KEY1播放");
    u8g2_DrawUTF8(&screen, 14, 51, "按下USER_KEY2退出");
...
video_page::video_page()
{
    ...
    this->key_handlers[USER_KEY_2].on_pressed = [](key_state) { route_to(&buzzer_menu_page_instance); };
    this->key_handlers[USER_KEY_1].on_pressed = [this](key_state) {
        buzzer_start_play(songs[this->song_id].tones, songs[this->song_id].tone_count);
    };
}
