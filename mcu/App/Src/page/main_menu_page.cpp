...
static void on_enter_mp3()
{
    mp3_menu_page_instance.focus_to_without_transition(0);
    route_to(&mp3_menu_page_instance);
}

static void on_enter_adc()
{
    route_to(&adc_page_instance);
}
...
static menu_item items[] = {
    ...
    {
        .text = "MP3",
        .on_enter = on_enter_mp3,
    },

    {
        .text = "ADC",
        .on_enter = on_enter_adc,
    },
    {
        .text = "游戏",
...
menu_page main_menu_page_instance("[ CAST 学习板 2025 ]", items, sizeof(items) / sizeof(items[0]));
