...
snake_game_over_page::snake_game_over_page()
{
    ...
    this->key_handlers[USER_KEY_2].on_pressed = [this](key_state) { route_to(&game_menu_page_instance); };
    //this->key_handlers[USER_KEY_1].on_pressed = [this](key_state) { enter_menu_item(); };
}
