...
#pragma ide diagnostic ignored "UnreachableCode"
    ...
    else
    {
        ...
        states[0] = HAL_GPIO_ReadPin(KEY_Y0_GPIO_Port, KEY_Y0_Pin) == GPIO_PIN_SET;
        states[1] = HAL_GPIO_ReadPin(KEY_Y1_GPIO_Port, KEY_Y1_Pin) == GPIO_PIN_SET;
        states[2] = HAL_GPIO_ReadPin(KEY_Y2_GPIO_Port, KEY_Y2_Pin) == GPIO_PIN_SET;
        states[3] = HAL_GPIO_ReadPin(KEY_Y3_GPIO_Port, KEY_Y3_Pin) == GPIO_PIN_SET;
    }
...
{
    scan_column_in_matrix(KEY_X0_GPIO_Port, KEY_X0_Pin, &states[0]);
    scan_column_in_matrix(KEY_X1_GPIO_Port, KEY_X1_Pin, &states[4]);
    scan_column_in_matrix(KEY_X2_GPIO_Port, KEY_X2_Pin, &states[8]);
    scan_column_in_matrix(KEY_X3_GPIO_Port, KEY_X3_Pin, &states[12]);
}
