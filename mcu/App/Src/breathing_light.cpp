...
constexpr TIM_HandleTypeDef *led_controller = &htim4;

constexpr uint32_t channel_blue = TIM_CHANNEL_1;
constexpr uint32_t channel_green = TIM_CHANNEL_2;
constexpr uint32_t channel_red = TIM_CHANNEL_3;
